...
$catalog = query("SELECT * FROM catalog WHERE id = $id");
$query = ("SELECT * FROM catalog WHERE id = $id")[0];
$catalog = $conn->query($query);
...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="img/ip12.png" alt="" width="80%" id="productimg">
            ...
            <div class="col-2">
                <p> Home / Phone </p>
                <h1> Iphone 12 </h1>
                <h5> iPhone 12. Layar Super Retina XDR 6,1 inci yang begitu cerah.
                    ...
                    Chip A14 Bionic yang andal. Dan aksesori MagSafe baru untuk kemudahan pemasangan dan pengisian daya nirkabel yang lebih cepat.3
                    Saatnya bersenang-senang.</h5>
                <select>
                ...
                <a href="formpayment.php" class="btn">Add To Cart</a>
                <h5>
                    Isi Kotak :
